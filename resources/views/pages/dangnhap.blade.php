			...
			<div class="wrap-login100 p-l-110 p-r-110 p-t-62 p-b-33">
				<form class="login100-form validate-form flex-sb flex-w form-class" method="post" action="dangnhap" id="form-login">
					...
					<div class="p-t-31 p-b-9">
						...
						<input class="" type="text" id="email" placeholder="Nhập email" name="email" value="{{old('email')}}" style="width: 100%;height: 60px;padding: 12px 20px;margin: 8px 0;display: inline-block;border: 1px solid #e6e6e6;border-radius: 10px;box-sizing: border-box;background-color: #f7f7f7;">
					<div class="p-t-13 p-b-9">
						<span class="txt1">
							Password
						</span>
					</div>
						<input class="input100" type="password" id="password" placeholder="Nhập password" name="password" style="width: 100%;height: 60px;padding: 12px 20px;margin: 8px 0;display: inline-block;border: 1px solid #e6e6e6;border-radius: 10px;box-sizing: border-box;background-color: #f7f7f7;">
					<div class="clear"></div>
