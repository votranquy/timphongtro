		...
		<div class="">
			<div class="user_form_pro_content">
				<div class="module_title">
					<span>Quản lý tin cần thuê</span>
				</div>
				<div class="clear"></div>
                @if(session('thongbao'))
					...
					<table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr class="odd gradeX" align="center">
                                ...
                                <td class="center">
                                    <a href="user/baidang/baicanthue/sua/{{$bd->id}}" class="btn btn-success">Sửa</a>
                                </td>
                                 <td>
                                    <a href="user/baidang/baicanthue/xoa/{{$bd->id}}" onclick="return confirm('Bạn đã chắc xóa ?');" title="Xóa" class="btn btn-danger">
